...
rdf_file = namedtuple("rdf_file", "content source basename")
...
MODEL_MODIFICATIONDATE: str = (
    "{http://www.eurofiling.info/xbrl/ext/model}modificationDate"
)
...
MODEL_ISDEFAULTMEMBER: str = (
    "{http://www.eurofiling.info/xbrl/ext/model}isDefaultMember"
)
